...
def _call_provider(provider_config, prompt, max_tokens=500):
    """
...
def _failover_call(prompt, providers, max_tokens=500):
    """
    按顺序尝试所有中转站，第一个成功就返回
